...
def onmessage(update,bot:ObigramClient):
    try:
        ...
        #set in debug
        tl_admin_user = os.environ.get('darielxd')
        ...
        if '/start' in msgText:
            ...
            #    bot_token = '5897158099:AAGh-_RE9nCgK3ST2SBZY4EPfQ1mUgTBdtM'
...
def main():
    bot_token = os.environ.get('5897158099:AAGh-_RE9nCgK3ST2SBZY4EPfQ1mUgTBdtM')
